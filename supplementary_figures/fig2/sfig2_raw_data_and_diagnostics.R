# =============================================================================
# Supplementary Figure 2 — Raw Data and Model Diagnostics for LMM 1
# =============================================================================
#
# Paper:  ReFOFA (NCOMMS-24-11279)
#
# This script generates all five panels of Supplementary Figure 2:
...
if (requireNamespace("rstudioapi", quietly = TRUE) && rstudioapi::isAvailable()) {
  ...
  # Fallback: assumes the user is in the supplementary_figures/fig2/ directory
}
...
png("sfig2_panels_DE_diagnostics.png", width = 800, height = 1600, res = 150)
...
dev.off()
cat("\nPanels D & E saved: sfig2_panels_DE_diagnostics.png\n")
...
ggsave("sfig2_panel_A_raw_data.pdf", pA, width = 10, height = 6)
ggsave("sfig2_panel_B_trajectories.pdf", pB, width = 10, height = 6)
ggsave("sfig2_panel_C_slopes.pdf", pC, width = 8, height = 6)
...
ggsave("sfig2_panels_ABC_combined.png", left_column,
       width = 10, height = 18)
cat("Panels A-C combined saved: sfig2_panels_ABC_combined.png\n")

cat("\n=== Supplementary Figure 2 complete ===\n")
cat("Assemble final figure from:\n")
cat("  Left column:  sfig2_panels_ABC_combined.png\n")
cat("  Right column: sfig2_panels_DE_diagnostics.png\n")
