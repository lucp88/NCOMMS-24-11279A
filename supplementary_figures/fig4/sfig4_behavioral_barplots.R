# =============================================================================
# Supplementary Figure 4 — Behavioral Performance: Detection and Recognition
#                          Response Latencies
# =============================================================================
#
...
#
# Data source: sourceData.xlsx, tab "SFig. 4"
#
# Dependencies:
...
means <- read_excel("sourceData.xlsx", sheet = "SFig. 4", skip = 1)
