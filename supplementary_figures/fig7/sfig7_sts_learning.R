# =============================================================================
# Supplementary Figure 7 — STS Control Analysis: Learning
# =============================================================================
#
...
if (requireNamespace("rstudioapi", quietly = TRUE) && rstudioapi::isAvailable()) {
  ...
  # Fallback: assumes the user has opened R in the fig7/ directory
}
...
df <- read_excel("sourceData.xlsx", sheet = "SFig. 7", skip = 1)
