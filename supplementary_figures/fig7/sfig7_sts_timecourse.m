%% Supplementary Figure 7 — STS Time-Course: Between-Session Comparison
...
%
% Data source: sourceData.xlsx, tab "SFig. 7-TC"
...
% Read from sourceData.xlsx "SFig. 7-TC" tab
sourceFile = fullfile('..', '..', 'sourceData.xlsx');
T = readtable(sourceFile, 'Sheet', 'SFig. 7-TC');
...
sgtitle('Supplementary Figure 7: STS Between-Session Comparison');
