# =============================================================================
# Supplementary Figure 8 — STS Control: Models 6 & 7 with STS
...
predictor_labels <- c(
  ...
  Detection_FRMS         = "Detection FRMS",
  `FFA:OFA`              = "FFA * OFA",
  `FFA:Regulation1`      = "FFA * Session",
  `OFA:Regulation1`      = "OFA * Session",
  `STS:Regulation1`      = "STS * Session",
  `FFA:OFA:Regulation1`  = "FFA * OFA * Session"
)
...
plot_coef <- dwplot(
  ...
  vars_order   = c("FFA", "OFA", "STS", "Regulation1", "Training_Day.L",
                    "FFA:OFA", "FFA:Regulation1", "OFA:Regulation1",
                    "STS:Regulation1", "FFA:OFA:Regulation1")
) %>%
  relabel_predictors(predictor_labels) +
